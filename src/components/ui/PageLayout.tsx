...
const PageLayout = ({
    ...
    return (
        <>
            <div className={cn("relative h-full w-full bg-gray-800 flex-col justify-end", className)}>
                ...
                <NavDrawer variant={variant}>
                    <div className="h-13 w-13 absolute top-5 left-5 z-50">
                        <Link to="/" aria-label="Go to home page" className="focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 rounded-sm">
                    ...
                    <div className='bg-gray-900/90 w-full h-full z-20 absolute top-0'>
                        <img src={BgTextureImg} alt="Background Texture" className="h-full w-full object-cover opacity-28 z-0" />
                    </div>
