...
function WorkoutDaySection({ exercises, name, setCount, onStartSession }: WorkoutDaySectionProps) {
    return (
        <div className="w-full h-full flex flex-col space-y-4">
            {/* Day Header */}
            <div className="flex items-center justify-between">
                <div>
                    <p className="text-white/40 text-xs uppercase tracking-wider mb-1">Today's Workout</p>
            ...
            <div className={cn(
                ...
                <div className="text-center flex-1">
                    ...
                    <div className="text-xs text-white/40 uppercase tracking-wider mt-1">Exercises</div>
                </div>
                <div className="h-12 w-px bg-white/10" />
                <div className="text-center flex-1">
                    <div className="text-3xl font-bold text-amber-400 font-mono">{setCount}</div>
                    ...
                    >
                        <div className="flex items-center gap-3 mb-3">
                            ...
                            <div className="flex-1">
                                <h5 className="font-display text-lg text-white/90">{item.exercise.name}</h5>
...
function Page() {
    const { currentDayIndex, activeRoutineId, routines, exercises, startSession } = useAppStore();
